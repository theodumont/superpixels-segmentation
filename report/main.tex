...
\section*{Appendices}
    ...
    \begin{table}[!ht]
            ...
            \begin{tabular}{|c||c|c|c|c|c|c|c|}
                ...
                \hline
                \hline
                3 & 4 & $10^{-2}$ & $\times .5$ every 2 ep. & $10^{-4}$ & 0 & & \multirow{6}{*}{$d=7$}\\
                ...
                \hline
                6 & 7 & $10^{-2}$ & $\times .5$ every 2 ep. & $10^{-4}$ & 0 & from run 0 ep.5 & \multirow{6}{*}{\shortstack{$lr_0=10^{-2}$,\\then $10^{-3}$\\after 10 ep.}}\\
                ...
                \hline
                12 & 7 & $10^{-2}$ & $10^{-3}$ after 10 ep. & $10^{-3}$ & $10^{-6}$ & \multirow{2}{*}{no improvement} & \multirow{2}{*}{$\alpha_{TV}=0$}\\
