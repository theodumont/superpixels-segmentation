    ...
    \subsection{Superpixels}
        ...
        \subsubsection{A good superpixel segmentation}
            ...
            \begin{itemize}
                ...
                \item \textbf{Undersegmentation Error.} \cite{todo:Undersegmentation} Undersegmentation Error measures the ``leakage'' of the superpixels over the ground truth.  We adopt the formulation proposed by Neubert and Protzel in~\cite{neubert2012}:
                $$
