...
parser.add_argument('d', help="network length", type=int)
...
if __name__ == '__main__':
    ...
    def learning():
        ...
        for epoch in range(start_epoches, num_epochs):  # loop over the dataset multiple times
